...
class EE_U_DUMP_RES_PM(DataAcquisition):
    """
    Subclass of DataAquistion to query ee_u_dump_res_pm
    """
    ...
    def __init__(self,
        ...
        super(EE_U_DUMP_RES_PM, self).__init__(circuit_type, circuit_name, timestamp_fgc)
    ...
    def get_signal_data(self) -> list:
        ...
        """
        return self.query_builder.query_ee_u_dump_res_pm(self.signal_timestamp, self.timestamp_fgc, system=self.systems,
    ...
    def get_reference_signal_data(self) -> list:
        ...
        signal_timestamp_ref = self.query_builder.find_source_timestamp_ee(timestamp_fgc_ref, system=self.systems).loc[
            0, 'timestamp']
        return self.query_builder.query_ee_u_dump_res_pm(signal_timestamp_ref, timestamp_fgc_ref, system=self.systems,
                                                         signal_names=self.signal_names)