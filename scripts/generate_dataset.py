...
from src.datasets.rb_fpa_snapshots_ee_plateau import RBFPASnapshotsEEPlateauDataset
...
if __name__ == "__main__":
    ...
    dataset_path = Path("/mnt/d/datasets/202201110_RBFPASnapshotsEEPlateauDataset")
    plot_dataset_path = Path("/mnt/d/datasets/202201110_RBFPASnapshotsEEPlateauDataset_plots")
