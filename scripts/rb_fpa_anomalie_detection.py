...
if __name__ == "__main__":
    # define paths
    dataset_path = Path("/mnt/d/datasets/20220707_sec_dataset")
    plot_dataset_path = Path("/mnt/d/datasets/20220707_sec_dataset_plots")
    ...
    # load dataset
    dataset = load_dataset(creator=RBFPASecQuench, # RBFPAPrimQuench,
